...
module Gcore
  ...
  class AiClient
    ...
    attr_reader :prompt_builder_class, :tools_module

    def initialize(prompt_builder_class: PromptBuilder, tools_module: Tools)
    ...
    def ask(question, context, binding: nil, on_response: nil)
      ...
      tools = @tools_module.to_definitions
    ...
    def execute_tool(tool_name, args)
      tool_class = @tools_module.find_tool(tool_name)
